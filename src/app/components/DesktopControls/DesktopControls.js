...
const FooterContainer = styled(Box)({
    ...
    display: "flex",
    justifyContent: "center", // Center the footer links
    alignItems: "center",
    ...
    return (
        <BackgroundContainer>
            ...
            <MessageContainer>
                ...
                <Typography
                    variant="h5"
                    style={{fontSize: "2rem", color: "#000333", fontWeight: "revert"}} // Slightly bigger and apply the same color
                >
                ...
                >
                    Pints is your guide to finding the cheapest pints in Central London, helping you discover affordable
                    pubs and bars within 1000 meters. With our user-friendly app, you can quickly compare prices and
                    enjoy your favorite drinks at the best deals, whether you’re out for a casual evening or unwinding
                    after work.
                </Typography>
            </MessageContainer>
            ...
            <FooterContainer>
                <Box display="flex" alignItems="center">
                    <FooterLink component="a" href="/terms">
                        Terms and Conditions
                    </FooterLink>
                    <FooterLink component="a" href="/privacy">
                        Privacy Policy
                    </FooterLink>
                    <FooterLink component="a" href="mailto:me@jack-robertson.co.uk">
                        Contact Us
                    </FooterLink>
                </Box>
            </FooterContainer>
